        ...
        <div className="w-5/12 flex-coloum-start-center">
          ...
          <div className="my-6 mx-6">
            ...
            <p className="main-footer-text">
              Subline write here Subline write here write Sub line wtte here
              Subline writes here woo Subline write here Subline write
              heressSubline write weher here Subline write here write Sub line
              write here Subline write where eir woo Subline writ e here Subline
              write heress Sub line write qhere write Subline write here write
              Sub line write here Subline write here woo
            </p>
          </div>
      ...
      <div className="flex-row-center-between footer-copywright-section">
        <div>
          ...
          <div className="flex-row-center">
            <span className="hover:text-white ml-4 mr-6 text-light-white-500">
              <a href="home.html">Terms and Conditions</a>
            </span>
            <ul className="">
              <li>
