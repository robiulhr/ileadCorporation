...
const SmallForm = (props) => {
    ...
    return (
        <div className='pr-[9rem] my-48 smallForm'>
             ...
             <p className="main-paragraph-gray pb-16 text-justify text-[1.4rem]">{paragraph}</p>
            ...
            <form className=''>
                ...
                <div>
                  ...
                  <div className='flex-row-center justify-end py-5'>
                        <button type='submit' className='btn btn-primary-blue-transparent text-[1.4rem] py-3 px-16 rounded-[4rem]'>{btnText}</button>
                  </div>
            </form>
