    ...
    <AdminPagesWrapper>
      <AdminDashboardSidebarNav>
        <AdminDashboardMainContentWrapper>
          <div>
            <AdminTitle title={"Lead Analytics"} />
          </div>
          ...
          <FourDivRow>
            <InfoCountCart text={"Total Leads"} count={"512,568"} />
            <InfoCountCart text={"Today Import"} count={"5,688"} />
            <InfoCountCart text={"Total Sale"} count={"68,996"} />
            <InfoCountCart text={"Today Sale"} count={"8,696"} />
          </FourDivRow>
