...
const CustomerCare = () => {
    return (
        <div>
            ...
            <h2 className='main-heading-dark-blue text-[2.6rem] mt-20 mb-10 mx-5 text-center'>Guides, answers, and advice from MailSale Customer Care Team</h2>
            <p className='main-paragraph-gray text-center mb-3 px-32'>Subline write here Subline write here write Sub line write here Subline write here woo Subline write here Subline write heress</p>
            ...
            <div className='mt-40 mb-56  flex-coloum-center'>
                ...
                <button className='btn btn-primary-transparent-blue px-48 my-5'>Contact With Us</button>
            </div>
