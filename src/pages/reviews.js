    ...
    return (
        <div>
            ...
            <div className='container'>
                <h2 className='main-heading-primary-blue !text-[2.2rem]'>Client Reviews</h2>
                <p className='main-paragraph-gray pr-40 !text-[1.9rem]  tracking-tight font-medium'>Subline write here Subline write here write Sub line write here Subline write here woo Subline write here Subline write heress</p>
            </div>
            <PrimaryTab 
                List={ClientreveiwsBycatagoryContent.map(ele=>ele.category)}
            >
             { ClientreveiwsBycatagoryContent.map((ele,ind)=>{
                       return <div className='transition duration-1000'>
                            ...
                            <div className='flex-row-center justify-end my-10'>
                                                <button className='btn btn-primary-blue-transparent'>Load More Reviews</button>
                            </div>
                        </div>
