        ...
        <>
            <div className='container'>
                    ...
                    <FindNowBtn  
                        ...
                        btnText={'Find Now'}
                        >
                            <h1 className='dashboard-findbtn-heading'>We have found over <span>260 million leads</span> for over <span>680,000 users</span> in the last 12 months</h1>
                        </FindNowBtn>
                     <ImgNdestwosec 
                        flexRowReverse={true}
                     >
            ...
            <div className='pt-16 pb-52 flex-coloum-center'>
                ...
                <div className='m-10'>
                    <button className='btn btn-primary-blue-transparent px-36 border-4 text-[1.7rem]'>Sign Up</button>
                    <button className='btn btn-primary-transparent-blue px-36 border-4 mx-14 text-[1.7rem]'>Talks to Sales</button>
                    <button className='btn btn-primary-transparent-blue px-36 border-4 text-[1.7rem]'>Pricing</button>
                </div>
            </div>
        </>
