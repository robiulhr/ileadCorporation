        ...
        <div className='container'>
                ...
                />
                 <FindNowBtn  
                        ...
                        btnText={'Find Now'}
                        >
                            <h1 className='dashboard-findbtn-heading text-normal-dark-blue my-4 text-[1.5rem] ml-[-10rem]'>Your perfect lead is a click away. Let's find them.</h1>
                        </FindNowBtn>
                <div className="my-44 flex-coloum-center">
                    ...
                    <button className='btn btn-primary-blue-transparent px-20 border-2 text-[1.3rem]'>Join Now</button>
                </div>
                <div className='my-14'>
                <ImgNdestwosec 
                        flexRowReverse
